...
# ==========================================================================================
#
#   This files was copied from SatelliteToolbox.jl because the functionality is required by
#   SGP4 model. The functions here **must not** be exported to avoid interferences.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#
# References
...
"""
    j2000_to_gmst(J2000_UT1::T) where T<:Number
...
"""
function j2000_to_gmst(J2000_UT1::T) where T<:Number
...
- **[1]** Vallado, D. A (2013). Fundamentals of Astrodynamics and Applications. Microcosm
    Press, Hawthorn, CA, USA.
"""
jd_to_gmst(JD_UT1::Number) = j2000_to_gmst(JD_UT1 - 2451545.0)
